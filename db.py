...
class Invoice(models.Model):
    id = models.AutoField(db_column='Id', primary_key=True)  # Field name made lowercase.
    invoicenumber = models.CharField(db_column='InvoiceNumber', unique=True, max_length=64)  # Field name made lowercase.
    quantity = models.IntegerField(db_column='Quantity')  # Field name made lowercase.
    itemprice = models.CharField(db_column='ItemPrice', max_length=10)  # Field name made lowercase.
    discount = models.CharField(db_column='Discount', max_length=10)  # Field name made lowercase.
    totalprice = models.CharField(db_column='TotalPrice', max_length=10)  # Field name made lowercase.
...
class Product(models.Model):
    ...
    itemcode = models.CharField(db_column='ItemCode', max_length=128)  # Field name made lowercase.
    quantity = models.IntegerField(db_column='Quantity')  # Field name made lowercase.
    available = models.IntegerField(db_column='Available')  # Field name made lowercase.
    mainprice = models.CharField(db_column='MainPrice', max_length=50)  # Field name made lowercase.
    saleprice = models.CharField(db_column='SalePrice', max_length=50)  # Field name made lowercase.
